...
internal abstract class KDeclarationContainerImpl : ClassBasedDeclarationContainer {
    ...
    private fun addParametersAndMasks(result: MutableList<Class<*>>, desc: String, isConstructor: Boolean) {
        ...
        if (isConstructor) {
            ...
            // Note here that DEFAULT_CONSTRUCTOR_MARKER is counted as one argument in the current bytecode generation,
            // so it must not be removed before calculating the size of the masks.
